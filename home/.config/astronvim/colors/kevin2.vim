...
highlight NonText       term=bold            ctermfg=LightBlue                                           gui=bold             guibg=Black   guifg=#4F4F4F
highlight SpecialKey    term=bold            ctermfg=LightBlue                          ctermfg=LightRed                      guibg=Black   guifg=#4F4F4F
highlight SpellBad      term=bold            ctermbg=LightBlue                          ctermfg=LightRed                      guibg=Black   guifg=#CAE1FF
highlight SpellCap      term=bold            ctermbg=LightBlue                          ctermfg=LightRed                      guibg=Black   guifg=#CAE1FF
highlight SpellLocal    term=bold            ctermbg=LightBlue                          ctermfg=LightRed                      guibg=Black   guifg=#CAE1FF
highlight SpellRare     term=bold            ctermbg=LightBlue                          ctermfg=LightRed                      guibg=Black   guifg=#CAE1FF
